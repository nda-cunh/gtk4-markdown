public class MarkdownParser {
	...
	public MarkdownParser () {
		try {
			...
			printerr ("InlineParser regex error: %s\n", e.message);
		}
	}
	...
	private void parse_inline (string line, MDNode parent) {
		...
		while (i < len) {
			...
			if (line[i] == '<') {
				if (process_html_inline_tag (line, parent, "i", ref i)) continue;
				if (process_html_inline_tag (line, parent, "b", ref i)) continue;
				if (process_html_inline_tag (line, parent, "u", ref i)) continue;
				if (process_html_inline_tag (line, parent, "s", ref i)) continue;
				if (process_html_inline_tag (line, parent, "strong", ref i)) continue;
				if (process_html_inline_tag (line, parent, "em", ref i)) continue;
				if (process_html_inline_tag (line, parent, "h1", ref i)) continue;
				if (process_html_inline_tag (line, parent, "h2", ref i)) continue;
				if (process_html_inline_tag (line, parent, "h3", ref i)) continue;
				if (process_html_inline_tag (line, parent, "h4", ref i)) continue;
				if (process_html_inline_tag (line, parent, "h5", ref i)) continue;
				if (process_html_inline_tag (line, parent, "h6", ref i)) continue;
			}

			if (process_inline_token ("==", line, parent, ref i)) continue;
			if (process_inline_token ("___", line, parent, ref i)) continue;
			if (process_inline_token ("***", line, parent, ref i)) continue;
			if (process_inline_token ("**", line, parent, ref i)) continue;
			if (process_inline_token ("~~", line, parent, ref i)) continue;
			if (process_inline_token ("*", line, parent, ref i)) continue;
			if (process_inline_token ("_", line, parent, ref i)) continue;
			if (process_inline_token ("~", line, parent, ref i)) continue;
			if (process_inline_token ("^", line, parent, ref i)) continue;
	...
	private bool starts_with (string line, int i, string token) {
		...
		return line.index_of (token, i) == i;
	}
